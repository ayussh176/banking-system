...
public class Main {
    public static void main(String[] args) {
        ...
        BankUtils.printDivider("Step 8 - STRUCTURAL: Decorator (Adding Insurance to Alice's account)");
        // ╔══════════════════════════════════╗
        // ║   DESIGN PATTERN: DECORATOR      ║
        // ╚══════════════════════════════════╝
        // Alice decides she wants insurance for her savings account.
        // We wrap the existing 'savings' object with an InsuranceDecorator.
        Account insuredSavings = new InsuranceDecorator(savings);
        
        System.out.println("Original Type: " + savings.getAccountType());
        System.out.println("Decorated Type: " + insuredSavings.getAccountType());
        
        // Use decorated behavior
        ((InsuranceDecorator) insuredSavings).applyInsurancePremium();
        
        System.out.println("Alice's balance after insurance premium: " + BankUtils.formatCurrency(insuredSavings.getBalance()));
    }
}
